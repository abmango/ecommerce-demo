...
<template>
    <ActionSection>
        ...
        <template #description>
            Revisa en que dispositivos se encuentra tu cuenta activa.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si es necesario, puedes cerrar sesión en todas tus otras sesiones de navegador en todos tus dispositivos. Algunas de tus sesiones recientes se 1  enumeran a continuación; sin embargo, esta lista 2  podría no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías actualizar tu contraseña. 
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    Para llevar a cabo esta acción primro esctibe tu clave:
